...
// 동적 쿼리 : 상황에 따라(파라미터가 어떤 값이 넘어가느냐에 따라) 쿼리문이 바뀌는 것
// 조건문, 반복문 사용
public class Application {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("1. if 확인하기");   // 조건문
            System.out.println("2. choose(when, otherwise) 확인하기");  // 조건문
            System.out.println("3. foreach 확인하기"); // 반복문
    ...
    private static void ifSubMenu() {
        ...
        do {
            ...
            // controller 안 만들고 간단하기 service 만 만들어서 실습함
            switch (no) {
